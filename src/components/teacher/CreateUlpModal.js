            ...
            const ulpAnalysisPrompt = `
                ...
                **ULP STRUCTURE AND CONTENT (IN ORDER):**
                ...
                3.  **Learning Plan Breakdown (Firm-Up, Deepen, Transfer):** Using ONLY the competencies from the 'Learning Competencies' input, classify each one and assign a unique code (A1, M1, T1, etc.).
            		...
            		* **Support Discussion:** For Firm-Up (A), provide questions to check for understanding and a comprehensive summarization of the lesson that will serve as the foundational knowledge and scaffold to the next lessons. For Deepen (M), provide a **detailed summarization** of key concepts in addition to in-depth elaboration and probing questions.
